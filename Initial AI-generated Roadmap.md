...
$$r(ϕ)=\left(\left|\frac{cos⁡(mϕ/4)}{a}|^{n_2}+|\frac{sin⁡(mϕ/4)}{b}\right|^{n_3} \right)^{−1/n_1}$$
...
- Zodiac index: $$Z=\left\lfloor\frac{\lambda\mod{2π}}{2π/12}\right\rfloor$$
- Later (optional Kepler): 
	mean anomaly $$M=n(t−t0)$$
	solve $$E−esin⁡E=M$$
	true anomaly $$ν=2\ arctan⁡ ⁣\left(\sqrt{\frac{1+e}{1−e}}tan\frac{⁡E}{2}\right)$$
